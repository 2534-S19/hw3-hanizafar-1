...
{
    static unsigned int previousSnapTIMER0 = MAX_VALUE;
    unsigned int currentSnap;
    bool returnValue;
    currentSnap = Timer32_getValue(TIMER32_0_BASE);
    returnValue = (currentSnap > previousSnapTIMER0);
    previousSnapTIMER0 = currentSnap;
    return returnValue;
}
...
{
    static unsigned int previousSnapTIMER1 = MAX_VALUE;
    unsigned int currentSnap;
    bool returnValue;

    currentSnap = Timer32_getValue(TIMER32_1_BASE);
    returnValue = (currentSnap > previousSnapTIMER1);
    previousSnapTIMER1 = currentSnap;
    return returnValue;
}
